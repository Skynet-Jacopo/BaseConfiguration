...
public class HttpRequest {
    ...
    public HttpRequest(Context context, String url, RequestMap params, USRequestListener requestListener) {
    ...
    public LoadControler doPost() {
        ...
        LoadControler mLoadControler = RequestManager.getInstance().request(Request.Method.POST, url, params, headers,
