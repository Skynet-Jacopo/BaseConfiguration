 ...
 */
public class SimpleFormatRequestListener implements RequestManager.RequestListener {

    private USRequestListener requestListener;

    public SimpleFormatRequestListener(USRequestListener requestListener){
